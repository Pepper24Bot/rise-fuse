...
export const UnifiedCLOB = {
  abi: [
    ...
    },
    {
      ...
      outputs: [{ name: "bookId", type: "uint256", internalType: "uint256" }],
      stateMutability: "nonpayable",
    },
    {
      type: "function",
      ...
      outputs: [
        {
          name: "",
          type: "tuple",
          internalType: "struct UnifiedCLOBV2.Order",
          components: [
            { name: "id", type: "uint256", internalType: "uint256" },
            { name: "trader", type: "address", internalType: "address" },
            { name: "bookId", type: "uint256", internalType: "uint256" },
            {
              name: "orderType",
              type: "uint8",
              internalType: "enum UnifiedCLOBV2.OrderType",
            },
            ...
            { name: "filled", type: "uint256", internalType: "uint256" },
            {
              name: "status",
              type: "uint8",
              internalType: "enum UnifiedCLOBV2.OrderStatus",
            },
            {
              name: "timestamp",
              type: "uint256",
    ...
    },
    {
      type: "function",
      name: "getOrderBook",
      inputs: [{ name: "bookId", type: "uint256", internalType: "uint256" }],
      outputs: [
        {
          name: "buyOrderIds",
          type: "uint256[]",
      ...
      outputs: [
        {
          name: "",
          type: "tuple",
          internalType: "struct UnifiedCLOBV2.TradingBook",
          components: [
            {
              name: "baseToken",
              type: "address",
    ...
    },
    {
      ...
      inputs: [
        { name: "bookId", type: "uint256", internalType: "uint256" },
        { name: "maxMatches", type: "uint256", internalType: "uint256" },
      ],
      outputs: [],
      stateMutability: "nonpayable",
    },
  ...
  addresses: {
    [riseTestnet.id]: "0x4DA4bbB5CD9cdCE0f632e414a00FA1fe2c34f50C",
  },
} as const;
